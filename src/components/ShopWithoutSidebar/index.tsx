...
const ShopWithoutSidebar = ({ products: initialProducts, categories: initialCategories }: ShopWithoutSidebarProps) => {
                ...
                <div className="flex flex-col lg:flex-row gap-4">
                  ...
                  <div className="lg:w-64">
                    <select
                      ...
                      className="w-full rounded-md border border-gray-3 py-3 px-4 outline-none ease-out duration-200 focus:border-transparent focus:shadow-input focus:ring-2 focus:ring-blue/20"
                    >
                      <option value="">All Categories</option>
                      {categories.map((category) => (
                        <option key={category.id} value={category.slug || category.title?.toLowerCase()}>
                          {category.title}
                        </option>
                      ))}
                    </select>
                  ...
                  {(selectedCategory || searchQuery) && (
                    <button
                      ...
                      className="px-4 py-2 bg-gray-100 text-gray-600 rounded-md hover:bg-gray-200 transition-colors whitespace-nowrap"
                    >
                      Clear Filters
                    </button>
                  )}
