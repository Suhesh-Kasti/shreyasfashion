...
const CategoryItem = ({ category, selected, onSelect }: CategoryItemProps) => {
  return (
    <button
      ...
      onClick={() => onSelect(selected ? null : category.slug || category.title.toLowerCase())}
    >
...
const CategoryDropdown = ({ categories, selectedCategory, onCategorySelect }: CategoryDropdownProps) => {
      ...
      >
        {categories.map((category, key) => (
          <CategoryItem
            key={key}
            category={category}
            selected={selectedCategory === (category.slug || category.title?.toLowerCase())}
