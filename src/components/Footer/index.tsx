...
import { getBrandName, BRAND_CONFIG, getSocialLinks, getFooterLinks, getBrandEmail, getBrandPhone, getBrandAddress } from "@/config/brand";
        ...
        <div className="flex flex-wrap xl:flex-nowrap gap-10 xl:gap-19 xl:justify-between pt-17.5 xl:pt-22.5 pb-10 xl:pb-15">
          ...
          <div className="w-full sm:w-auto">
            ...
            <ul className="flex flex-col gap-3">
              ...
              <li>
                <a className="ease-out duration-200 hover:text-blue text-brand-text" href="/faq">
                  FAQ’s
                </a>
              </li>
              <li>
          ...
          <div className="w-full sm:w-auto">
            ...
            <div className="flex lg:justify-end gap-4">
              ...
              <a
                ...
                className="flex items-center justify-center w-12 h-12 bg-gradient-to-r from-purple-500 to-pink-500 text-white rounded-lg hover:shadow-lg transition-all duration-200"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center justify-center w-12 h-12 bg-blue-600 text-white rounded-lg hover:bg-blue-700 hover:shadow-lg transition-all duration-200"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center justify-center w-12 h-12 bg-black text-white rounded-lg hover:bg-gray-800 hover:shadow-lg transition-all duration-200"
          ...
          <div className="flex gap-5 flex-col lg:flex-row lg:items-center lg:justify-between">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-4 justify-center lg:justify-end">
              ...
              <div className="flex flex-wrap items-center justify-center sm:justify-start gap-3 lg:gap-6">
                {/* e-Sewa */}
                <div className="flex items-center gap-2 px-2 sm:px-3 py-2 bg-green-100 rounded-lg">
                  <div className="w-6 h-6 sm:w-8 sm:h-8 bg-green-600 rounded-full flex items-center justify-center">
                    <span className="text-white font-bold text-xs sm:text-sm">e</span>
                  </div>
                  <span className="font-medium text-green-700 text-sm sm:text-base">e-Sewa</span>
                </div>

                {/* Cash on Delivery */}
                <div className="flex items-center gap-2 px-2 sm:px-3 py-2 bg-blue-100 rounded-lg">
                  <svg className="w-5 h-5 sm:w-6 sm:h-6 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z" />
                  </svg>
                  <span className="font-medium text-blue-700 text-sm sm:text-base">COD</span>
                </div>

                {/* Bank Transfer */}
                <div className="flex items-center gap-2 px-2 sm:px-3 py-2 bg-purple-100 rounded-lg">
                  <svg className="w-5 h-5 sm:w-6 sm:h-6 text-purple-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z" />
                  </svg>
                  <span className="font-medium text-purple-700 text-sm sm:text-base">Bank</span>
                </div>
              </div>
            </div>
          </div>
